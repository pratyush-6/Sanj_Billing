<x-app-layout>
    ...
    <div class="space-y-4">
        ...
        <div class="flex justify-between items-center">
            <a href="{{ route('expense-sub-categories.index') }}" class="text-sm text-brand-600 dark:text-brand-400 hover:text-brand-800 dark:hover:text-brand-300 font-medium">Manage Sub Categories &rarr;</a>
