<div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
    ...
    <div>
        ...
        <select id="account_type" name="account_type" class="mt-1 block w-full bg-white dark:bg-ink-800 text-ink-900 dark:text-ink-100 border-ink-300 dark:border-ink-600 rounded-lg shadow-sm text-sm focus:border-brand-500 focus:ring-brand-500" required>
    ...
    <div>
        ...
        @if ($bankAccount)
            <p class="text-xs text-ink-400 dark:text-ink-500 mt-1">Opening balance can't be changed after creation.</p>
        @endif
