    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                @if (session('status'))
                    <div class="mb-4 p-3 bg-green-50 text-green-800 rounded-md text-sm">{{ session('status') }}</div>
                @endif
                ...
                <form method="POST" action="{{ route('company.update') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input list="business-types" id="business_type" name="business_type" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" value="{{ old('business_type', $company?->business_type) }}" />
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="business_description" name="business_description" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">{{ old('business_description', $company?->business_description) }}</textarea>
